 ...
 */
     ...
     */
        ...
        public static function response($body = null, $status = 200, $headers = [])
        {
                    ...
                    /**
         * Get an invokable object that returns a sequence of responses in orders for use during stubbing.
         *
        ...
        public static function assertSent($callback)
        {
                    ...
                    /**
         * Assert that the given request was sent in the given orders.
         *
     ...
     */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets the preferred format for the response by inspecting, in the following orders:
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of charsets acceptable by the client browser in preferable orders.
         *
         * @return string[]
         * @static
         */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of encodings acceptable by the client browser in preferable orders.
         *
         * @return string[]
         * @static
         */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of content types acceptable by the client browser in preferable orders.
         *
         * @return string[]
         * @static
         */
...
')
     ...
     */
        ...
        public static function setDefaultActionRules($rules = [])
        {
                    ...
                    /**
         * Set action groups orders for the cart
         *
         * @param array $order The action groups orders
         * @return \Jackiedo\Cart\Cart
         * @static
         */
...
namespace  {
            ...
            public static function lazyById($chunkSize = 1000, $column = null, $alias = null)
            {
                ...
                /**
             * Query lazily, by chunking the results of a query by comparing IDs in descending orders.
             *
             * @param int $chunkSize
             * @param string|null $column
             * @param string|null $alias
            ...
            public static function forPageAfterId($perPage = 15, $lastId = 0, $column = 'id')
            {
                ...
                /**
             * Remove all existing orders and optionally add a new orders.
             *
